...
import { ReactNode, forwardRef, useMemo, useState, RefAttributes } from 'react'
...
export const Input: (props: InputProperties & RefAttributes<ComponentInternals<ContainerProperties>>) => ReactNode = forwardRef(
  (
    {
      variant = 'rect',
      prefix,
