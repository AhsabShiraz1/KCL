...
export default function IrmLevel5({ setNotification }: LevelProps) {
  ...
  return (
    <>
      <Suspense fallback={null}>
        <Model url="/assets/irm-scene-first.glb" position={[-195, -1, 150]} scale={5} rotation={[0, Math.PI , 0]} />
          ...
          >
            <Container flexDirection="column" alignItems="center">
              ...
              <Text fontSize={10} fontWeight="medium">
                The vessel is parked at the jetty and preparations for unloading are started
              </Text>
            </Container>
          </Container>
        </Root>
